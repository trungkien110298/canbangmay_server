...
api_problem_2.post("/api-problem_2", postAuth.isAuthenticated, (req, res) => {
	...
	//Run C++ program
	if (os.platform() == "win32") command = "cd optimization && start ALBP2-SA_greedy.exe";
	else command = "cd optimization &&  ./ALBP2-SA_greedy";
	cmd.get(
		command,
		//Send output
